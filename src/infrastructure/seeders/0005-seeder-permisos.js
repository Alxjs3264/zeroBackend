...
let items = [
  ...
  { id: Ids.permisos['usuarios:listadoReducido'], tipo: 'SISTEMA', nombre: 'usuarios:listadoReducido', descripcion: 'Permiso para listado reducido de usuarios', estado: 'ACTIVO' },
  ...
  { id: 'af15eb25-e052-486b-a967-660d61ecf0d1', tipo: 'SISTEMA', nombre: 'flujoplantilla:listar', descripcion: 'Permiso para listar flujoplantillas', estado: 'ACTIVO' },
  { id: '4cc343eb-0782-4739-8509-db79be8e416e', tipo: 'SISTEMA', nombre: 'flujoplantilla:listarpor', descripcion: 'Permiso para listar flujoplantilla por id', estado: 'ACTIVO' },
  { id: 'c5720a83-15c4-4641-8164-a0a4da7c3d8e', tipo: 'SISTEMA', nombre: 'flujoplantilla:crear', descripcion: 'Permiso para crear flujoplantilla', estado: 'ACTIVO' },
  { id: 'dcf487a4-7639-4073-b4f4-dff8530ff284', tipo: 'SISTEMA', nombre: 'flujoplantilla:actualizar', descripcion: 'Permiso para actualizar flujoplantilla', estado: 'ACTIVO' },
  { id: '66ffb4c4-bec3-4ad0-a1b3-f3bea8fe62da', tipo: 'SISTEMA', nombre: 'flujoplantilla:eliminar', descripcion: 'Permiso para eliminar flujoplantilla', estado: 'ACTIVO' },

  { id: Ids.permisos['bandeja:listar'], tipo: 'SISTEMA', nombre: 'bandeja:listar', descripcion: 'Permiso para listar documentos en bandeja de usuario', estado: 'ACTIVO' },
  { id: Ids.permisos['documento:crear'], tipo: 'SISTEMA', nombre: 'documento:crear', descripcion: 'Permiso para crear documentos', estado: 'ACTIVO' },
  { id: Ids.permisos['documento:actualizar'], tipo: 'SISTEMA', nombre: 'documento:actualizar', descripcion: 'Permiso para modificar documentos', estado: 'ACTIVO' },
  { id: Ids.permisos['documento:finalizar'], tipo: 'SISTEMA', nombre: 'documento:finalizar', descripcion: 'Permiso para finalizar documentos', estado: 'ACTIVO' },
  { id: Ids.permisos['documento:listar'], tipo: 'SISTEMA', nombre: 'documento:listar', descripcion: 'Permiso para listar documentos', estado: 'ACTIVO' },
  ...
  { id: Ids.permisos['apitoken:modificar'], tipo: 'INTEROPERABILIDAD', nombre: 'apitoken:modificar', descripcion: 'Permiso para modificar tokens api de interoperabilidad', estado: 'ACTIVO' },

  { id : "591dda3d-6796-4193-89f8-abbfbc101828", tipo: "SISTEMA", nombre: "documento:generarCite", descripcion: "Permiso para generar cite de documentos", estado: "ACTIVO"	},
	{ id : "512cd62d-d48f-4be9-ba90-5181f2fbbf55", tipo: "SISTEMA", nombre: "aplicaciones:crear", descripcion: "Permiso para listar planificacions", estado: "ACTIVO"	},
	{ id : "512cd62d-d48f-4be9-ba90-5181f2fbbf54", tipo: "SISTEMA", nombre: "aplicaciones:listar", descripcion: "Permiso para listar planificacions", estado: "ACTIVO"	},
	{ id : "512cd62d-d48f-4be9-ba90-5181f2fbbf56", tipo: "SISTEMA", nombre: "aplicaciones:actualizar", descripcion: "Permiso para listar planificacions", estado: "ACTIVO"	},
	{ id : "512cd62d-d48f-4be9-ba90-5181f2fbbf57", tipo: "SISTEMA", nombre: "aplicaciones:eliminar", descripcion: "Permiso para listar planificacions", estado: "ACTIVO"	},
	{ id : "ab0275d7-37ab-4dba-9bf1-12e7f10df1ef", tipo: "SISTEMA", nombre: "toolbar:buscador", descripcion: "Ver el buscador general", estado: "ACTIVO"	},
	{ id : "c403fd5c-14b4-4c98-823f-d0f5f0a6b267", tipo: "SISTEMA", nombre: "toolbar:apps", descripcion: "Ver cuadro de las apps relacionadas", estado: "ACTIVO"	},
	{ id : "80d5de4c-120b-49b7-bc1f-3672803250e2", tipo: "SISTEMA", nombre: "dashboard:publicaciones", descripcion: "Ver las publicaciones en el dashboard", estado: "ACTIVO"	},
	{ id : "0edb8e9c-9a1e-481b-93ca-e197f8aca0e3", tipo: "SISTEMA", nombre: "dashboard:funcionarios", descripcion: "Ver la lista de funcionarios en el dashboard", estado: "ACTIVO"	},
	{ id : "35eef3c9-c281-4ca4-84b2-418acfd3a864", tipo: "SISTEMA", nombre: "listado:flujos:documentos", descripcion: "Ver la lista de solicitudes para crear uno nuevo", estado: "ACTIVO"	},
	{ id : "e9b6fb57-a70d-47e6-9b44-18cb0022bbd5", tipo: "SISTEMA", nombre: "listado:gestion:documentos", descripcion: "Ver la lista de documentos para iniciar un nuevo documento", estado: "ACTIVO"	},
	
  { id : "9dfa6434-a465-4d9a-8067-bd6ef9163ffb", tipo: "SISTEMA", nombre: "listar:todo", descripcion: "Ver la lista completa sin restriccion de la entidad", estado: "ACTIVO"	}
];
