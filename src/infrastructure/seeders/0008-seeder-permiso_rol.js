...
let items = [
  ...
  // api token
  { id: 'd45275c2-e9cc-48df-9ea2-d0a907437b7e', id_rol: '88b0104c-1bd1-42b2-bb01-9bf0502bab5a', id_permiso: Ids.permisos['apitoken:modificar'] },

  { id: 'e88815b6-9e14-43b3-beb2-95ca5960e645', id_rol: Ids.roles.ministro, id_permiso: Ids.permisos['usuarios:listadoReducido'] },
  { id: '80da9d39-0de3-471a-8b61-d3a07ae6fb56', id_rol: Ids.roles.viceministro, id_permiso: Ids.permisos['usuarios:listadoReducido'] },
  { id: 'fccea4cc-a5f5-4cad-acc2-79b9448241da', id_rol: Ids.roles.directores, id_permiso: Ids.permisos['usuarios:listadoReducido'] },
  { id: '048e2370-3b93-440c-82bf-0b1045e1a027', id_rol: Ids.roles['jefes de unidad'], id_permiso: Ids.permisos['usuarios:listadoReducido'] },
  { id: '2a3bc225-0ba6-4abd-b650-81b166406cc0', id_rol: Ids.roles.secretaria, id_permiso: Ids.permisos['usuarios:listadoReducido'] },
  { id: 'ba79f533-dacb-401a-a007-67535c42091a', id_rol: Ids.roles.autoridades, id_permiso: Ids.permisos['usuarios:listadoReducido'] },
  { id: '965b8799-9a9e-4d2b-a76a-3de3617780d6', id_rol: Ids.roles['personal mjti'], id_permiso: Ids.permisos['usuarios:listadoReducido'] },

  // gestion documental
  { id: '901e651f-a358-f20a-fee8-cae812837784', id_rol: Ids.roles.ministro, id_permiso: Ids.permisos['bandeja:listar'] },
  { id: 'aad4b925-a691-42b7-930b-3f2e7707e7a0', id_rol: Ids.roles['ROL SUPER ADMIN'], id_permiso: Ids.permisos['bandeja:listar'] },
  { id: 'bdda8878-dc4d-49cd-9970-885708481d6b', id_rol: Ids.roles.viceministro, id_permiso: Ids.permisos['bandeja:listar'] },
  { id: 'a42d860e-3d6e-4f82-98a7-aa362283cc22', id_rol: Ids.roles.directores, id_permiso: Ids.permisos['bandeja:listar'] },
  { id: 'fad9c243-0bf2-4f5c-b8aa-2f469f851a29', id_rol: Ids.roles['jefes de unidad'], id_permiso: Ids.permisos['bandeja:listar'] },
  { id: '9b45eccd-b78d-4186-9d95-0a3a26a3076d', id_rol: Ids.roles.secretaria, id_permiso: Ids.permisos['bandeja:listar'] },
  { id: 'c5fee015-d1f8-4665-9fd7-da71e7bc822b', id_rol: Ids.roles.autoridades, id_permiso: Ids.permisos['bandeja:listar'] },
  { id: 'a6fc7849-2336-4b48-b658-396c1ef31781', id_rol: Ids.roles['personal mjti'], id_permiso: Ids.permisos['bandeja:listar'] },

  { id: 'cf96bb5f-3591-49e7-93ba-33fdc237d793', id_rol: Ids.roles.ministro, id_permiso: Ids.permisos['documento:crear'] },
  { id: 'ed2cb0fd-6a73-4fff-babd-6665b70b4c62', id_rol: Ids.roles.viceministro, id_permiso: Ids.permisos['documento:crear'] },
  { id: 'f7bf11b1-c21e-4127-be84-c37151ae2e6f', id_rol: Ids.roles.directores, id_permiso: Ids.permisos['documento:crear'] },
  { id: '08494e61-4047-4d1f-a830-5b04c0bd86ba', id_rol: Ids.roles['jefes de unidad'], id_permiso: Ids.permisos['documento:crear'] },
  { id: '6bfc999e-dd02-4a99-b18e-3e372a3f2b21', id_rol: Ids.roles.secretaria, id_permiso: Ids.permisos['documento:crear'] },
  { id: '51d7ce89-e880-41b2-aced-df6c6059786d', id_rol: Ids.roles.autoridades, id_permiso: Ids.permisos['documento:crear'] },
  { id: 'd4362d12-72ce-4a1c-8abb-a48ddc82de93', id_rol: Ids.roles['personal mjti'], id_permiso: Ids.permisos['documento:crear'] },

  { id: '53b2b236-f320-4223-b2af-51e2a2083503', id_rol: Ids.roles.ministro, id_permiso: Ids.permisos['documento:actualizar'] },
  { id: '55b7e88e-785c-4030-a34b-3ce2673b46e5', id_rol: Ids.roles.viceministro, id_permiso: Ids.permisos['documento:actualizar'] },
  { id: '907e95cc-3858-413d-b596-d7985802e50f', id_rol: Ids.roles.directores, id_permiso: Ids.permisos['documento:actualizar'] },
  { id: 'b74f77c3-a1c4-4cc0-882b-b3f6f51af145', id_rol: Ids.roles['jefes de unidad'], id_permiso: Ids.permisos['documento:actualizar'] },
  { id: '46c66507-4246-4213-8b34-8e8c03e9f114', id_rol: Ids.roles.secretaria, id_permiso: Ids.permisos['documento:actualizar'] },
  { id: '80ae6052-7b44-4570-8492-cbe821278aa8', id_rol: Ids.roles.autoridades, id_permiso: Ids.permisos['documento:actualizar'] },
  { id: '20d34016-7c63-4019-b6ec-acaf8ee2e132', id_rol: Ids.roles['personal mjti'], id_permiso: Ids.permisos['documento:actualizar'] },

  { id: '64a56622-4fcb-4204-a7c6-a0b93a23c55a', id_rol: Ids.roles.ministro, id_permiso: Ids.permisos['documento:finalizar'] },
  { id: 'ab8003ff-751b-48eb-930a-3c04a070880d', id_rol: Ids.roles.viceministro, id_permiso: Ids.permisos['documento:finalizar'] },
  { id: '2d38c9eb-1c6d-4ccb-970d-6eb69919ae3c', id_rol: Ids.roles.directores, id_permiso: Ids.permisos['documento:finalizar'] },
  { id: 'fb50792b-0e22-4262-afce-102698af7ffc', id_rol: Ids.roles['jefes de unidad'], id_permiso: Ids.permisos['documento:finalizar'] },
  { id: '273e4f6c-86d7-4769-8ce7-018e581e595f', id_rol: Ids.roles.secretaria, id_permiso: Ids.permisos['documento:finalizar'] },
  { id: 'ad883ed7-6eae-460b-912e-9912bef92217', id_rol: Ids.roles.autoridades, id_permiso: Ids.permisos['documento:finalizar'] },
  { id: '014ae636-47a4-4d86-98ae-70eb2941f6c8', id_rol: Ids.roles['personal mjti'], id_permiso: Ids.permisos['documento:finalizar'] },

  { id: '7eafb71b-7950-4a9d-8a43-4503472e1b76', id_rol: Ids.roles.ministro, id_permiso: Ids.permisos['documento:listar'] },
  { id: '720841ae-2477-4c2c-ad0d-20fb1e47f718', id_rol: Ids.roles.viceministro, id_permiso: Ids.permisos['documento:listar'] },
  { id: '4cef2af0-ee78-4f8b-99a1-06c22941f937', id_rol: Ids.roles.directores, id_permiso: Ids.permisos['documento:listar'] },
  { id: '66fc6b78-2074-4a3b-93f8-a93cff54cab8', id_rol: Ids.roles['jefes de unidad'], id_permiso: Ids.permisos['documento:listar'] },
  { id: 'b15610da-9272-4ab9-afe7-930ca368b7e7', id_rol: Ids.roles.secretaria, id_permiso: Ids.permisos['documento:listar'] },
  { id: '3ee2cc02-1ac5-45b7-947e-a49d7f15fb4d', id_rol: Ids.roles.autoridades, id_permiso: Ids.permisos['documento:listar'] },
  { id: '8bb88af5-9241-4c49-86a2-f145847f3ba3', id_rol: Ids.roles['personal mjti'], id_permiso: Ids.permisos['documento:listar'] },
  
  // Agregando permisos para ver listado de documentos y flujos
  { id: '2bf70469-0fdf-4bc4-aeca-beb7a6fbd3bf', id_rol: Ids.roles['personal mjti'], id_permiso: '35eef3c9-c281-4ca4-84b2-418acfd3a864'},
  { id: '5a23e640-9f88-4d38-b287-5e4f186e66da', id_rol: Ids.roles['personal mjti'], id_permiso: 'e9b6fb57-a70d-47e6-9b44-18cb0022bbd5'}
];
